...
import com.example.hbioss.chat;
...
public class chat extends ActionBarActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
        	Intent trocaTela = new Intent(chat.this,configuracoes.class);	
		    chat.this.startActivity(trocaTela);
		    chat.this.finish();
		    
            return true;
        }else if (id == R.id.perfil_id) {
        	Intent trocaTela = new Intent(chat.this,perfil.class);	
		    chat.this.startActivity(trocaTela);
		    chat.this.finish();
            ...
            if (eventConsumed)
            {
            	if(GestureListener.currentGestureDetected=="esquerda"){
            	  ...
            	  // TODO Auto-generated method stub
          	      Intent trocaTela = new Intent(chat.this,MainActivity.class);	
          	      chat.this.startActivity(trocaTela);
          	      chat.this.finish();
