...
import com.example.hbioss.conversas;
...
public class conversas extends ActionBarActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
        	Intent trocaTela = new Intent(conversas.this,configuracoes.class);	
        	conversas.this.startActivity(trocaTela);
		    conversas.this.finish();
		    
            return true;
        }else if (id == R.id.perfil_id) {
        	Intent trocaTela = new Intent(conversas.this,perfil.class);	
        	conversas.this.startActivity(trocaTela);
		    conversas.this.finish();
            ...
            if (eventConsumed)
            {
            	if(GestureListener.currentGestureDetected=="esquerda"){
            	  ...
            	  // TODO Auto-generated method stub
          	      Intent trocaTela = new Intent(conversas.this,MainActivity.class);	
          	      conversas.this.startActivity(trocaTela);
          	      conversas.this.finish();
